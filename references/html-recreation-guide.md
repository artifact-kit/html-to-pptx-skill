...
Use an import map so Babel-transformed inline modules can import the package by name:

```html
<script type="importmap">
  {
    "imports": {
      "@artifact-kit/pptxgenjs-jsx": "https://unpkg.com/@artifact-kit/pptxgenjs-jsx@0.1.0/dist/pptxgenjs-jsx.browser.es.js",
      "@artifact-kit/pptxgenjs-jsx/jsx-runtime": "https://unpkg.com/@artifact-kit/pptxgenjs-jsx@0.1.0/dist/jsx-runtime.browser.es.js",
      "@artifact-kit/pptxgenjs-jsx/jsx-dev-runtime": "https://unpkg.com/@artifact-kit/pptxgenjs-jsx@0.1.0/dist/jsx-runtime.browser.es.js"
    }
  }
</script>
...
- `Failed to resolve module specifier`: add or fix the import map entry for `@artifact-kit/pptxgenjs-jsx`.
